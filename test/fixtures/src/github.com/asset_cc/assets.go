...
type Asset struct {
	...
	Size       int           `json:"size"` //size in mm of asset
...
// ============================================================================================================================
// Init - initialize the chaincode - assets don’t need anything initlization, so let's run a dead simple test instead
// ============================================================================================================================
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	fmt.Println("Assets Is Starting Up")
	...
	// store compaitible assets application version
	err = stub.PutState("assets_ui", []byte("3.5.0"))
	if err != nil {
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "set_owner" { //change owner of a asset
		return set_owner(stub, args)
	} else if function == "init_owner" { //create a new asset owner
		return init_owner(stub, args)
	} else if function == "read_everything" { //read everything, (owners + assets + companies)
		return read_everything(stub)
	} else if function == "getHistory" { //read history of a asset (audit)
		return getHistory(stub, args)
	} else if function == "getAssetsByRange" { //read a bunch of assets by start and stop id
		return getAssetsByRange(stub, args)
	}

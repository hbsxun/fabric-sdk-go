...
// ============================================================================================================================
// Get Marble - get a asset asset from ledger
// ============================================================================================================================
func get_asset(stub shim.ChaincodeStubInterface, id string) (Marble, error) {
	var asset Marble
	...
	if asset.Id != id {                                     //test if asset is actually here or just nil
		return asset, errors.New("Marble does not exist - " + id)
	}

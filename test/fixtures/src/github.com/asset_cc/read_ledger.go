...
// ============================================================================================================================
// Get everything we need (owners + assets + companies)
//
// Inputs - none
//
// Returns:
...
func read_everything(stub shim.ChaincodeStubInterface) pb.Response {
	...
	for resultsIterator.HasNext() {
		...
		everything.Assets = append(everything.Assets, asset)   //add this asset to the list
	}
	...
	for ownersIterator.HasNext() {
		...
		everything.Owners = append(everything.Owners, owner)     //add this asset to the list
	}
...
//  "assets1" , "assets5"
// ============================================================================================================================
func getAssetsByRange(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 2 {

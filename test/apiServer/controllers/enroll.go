...
// @router / [get]
func (u *EnrollController) GetAll() {
	u.ServeJSON()
}
...
// @Failure 403 uid is empty
// @router /:uid [delete]
func (u *EnrollController) Delete() {
...
// @router /logout [get]
func (u *EnrollController) Logout() {

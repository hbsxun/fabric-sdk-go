...
func (this *Ledger) QueryTrans(txID string) (tx *TxInfo, err error) {
	...
	return &TxInfo{
		TxId:      txID,
		Signature: base64.StdEncoding.EncodeToString(si & payloadgnedData[0].Signature),
...
func (this *Ledger) QueryBlockByNumber(number int) (*BlockInfo, error) {
	...
	return &BlockInfo{
		...
		DataHash: base64.StdEncodinparseBodyg.EncodeToString(block.GetHeader().DataHash),

...
//if PeerUrl is "", installCC on allPeers in specified in config_test.yaml
func NewInstallAction(args *InstallCCArgs) (*installAction, error) {
	...
	common.Config().InitChaincodePath(flags, args.ChaincodePath)
	common.Config().InitChaincodeVersion(flags, args.ChaincodeVersion)
